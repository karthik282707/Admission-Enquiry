...
const AdmissionForm = ({ user, onLogout, isSimplified }) => {
    ...
    return (
        <div className="container animate-fade-in" style={{ padding: isSimplified ? '1rem' : '2rem' }}>
            {!isSimplified && (
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                    <div>
                        ...
                        <p style={{ color: 'var(--text-muted)' }}>Welcome, {user.username} | Student Portal</p>
                    </div>
            ...
            {isSimplified && (
                <div style={{ marginBottom: '2rem' }}>
                    <h2 className="font-outfit" style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>Student Admission</h2>
                    <p style={{ color: 'var(--text-muted)' }}>Please fill all the details below carefully.</p>
                </div>
            )}
